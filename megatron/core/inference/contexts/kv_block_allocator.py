...
class KVBlockAllocator:
    ...
    def reconstruct_routing_from_blocks(
        ...
        Args:
            ...
            prefetched_blocks: Routing arrays retained before lifecycle cleanup.
                Missing entries fall back to the allocator's live block storage.
        ...
        for bid in block_ids:
            routing = None if prefetched_blocks is None else prefetched_blocks.get(bid)
            if routing is None:
