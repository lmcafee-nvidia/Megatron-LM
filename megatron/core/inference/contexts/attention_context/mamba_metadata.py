...
class MambaMetadata:
    ...
    def __init__(
        ...
        Args:
            ...
            state_bank_count (int): Number of physical state banks per logical request slot.
        """
        ...
        # Per-request selector for the currently committed physical state bank.
    ...
    def compute_cpu_metadata(
        ...
        Returns:
            dict: Python metadata consumed by :meth:`load_from_cpu` after the H2D transfer.
        """
